...
See [Validators — normalising date formats](validators.md#example--normalising-date-formats)
for a validator that automatically converts `DD.MM.YYYY` → `YYYY-MM-DD`.
